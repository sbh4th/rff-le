...
Postwar divergence, then convergence
:::

![](images/us-le-gender.png){width="75%" fig-align="center"}
...
- Drugs (start of opioid epidemic...for whites)
:::
...
## {background-image="images/us-le-zoom.png" background-opacity=0.25 background-size="85%"}

### Unprecedented *three* consecutive years of life expectancy declines for the nation.
...
Holding DoD, cancers and CVD at 1992 levels, gap sill increases (at lower level)

<br>

Now these are part of the story?
...
Impact on rural areas varies by 'phase' of epidemic
...
More heterogeneity by sex, race, and place

:::

::: {.column width="80%"}
![](images/riddell-gap-men.png){width="80%"}
:::
...
## Can DoD explain this heterogeneity?
::: columns
::: {.column width="70%"}
